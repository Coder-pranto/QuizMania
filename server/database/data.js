const questions = [
  ...
  },
  {
    ...
    options: ['JSON.parse()', 'JSON.stringify()', 'JSON.decode()'],
  },
  {
    id: 8,
    question: 'What is a closure in JavaScript?',
    options: [
      'A function that has access to variables from its outer function',
  ...
  },
  {
    ...
    options: ['React', 'jQuery', 'Python'],
  },
];

const answers = [1, 0, 1, 0, 0, 0, 0, 0, 0, 2];
